CREATE OR ALTER FUNCTION dbo.fn_GetColumnListByAlphaOrder
    (
...
/* Test function
    DECLARE @tblName VARCHAR(255) = 'vw_Columns'
    DECLARE @tblSchema VARCHAR(255) = 'stage2'
    DECLARE @excludeColumnsList VARCHAR(MAX) = 'TableVersionId, ColumnName'

    SELECT dbo.fn_GetColumnListByAlphaOrder(@tblSchema, @tblName, @excludeColumnsList)
*/