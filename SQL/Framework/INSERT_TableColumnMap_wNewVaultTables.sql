-- Create a new stored procedure called 'sp_InsertTableColumnMap' in schema 'dbo'
-- Drop the stored procedure if it already exists
IF EXISTS (
SELECT *
    FROM INFORMATION_SCHEMA.ROUTINES
    WHERE SPECIFIC_SCHEMA = N'dbo'
    AND SPECIFIC_NAME = N'sp_InsertTableColumnMap'
    AND ROUTINE_TYPE = N'PROCEDURE'
)
DROP PROCEDURE dbo.sp_InsertTableColumnMap
GO
...
EXECUTE dbo.sp_InsertTableColumnMap 
--  */